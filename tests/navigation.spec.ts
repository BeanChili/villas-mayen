...
test.describe('Navigation', () => {
  ...
  test.describe('URL Routing', () => {
    ...
    test('should navigate directly to /catalog/products', async ({ page }) => {
    ...
    test('should navigate directly to /rooms', async ({ page }) => {
    ...
    test('should navigate directly to /reports/closings', async ({ page }) => {
      await page.goto('/reports/closings');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Active Navigation State', () => {
    ...
    test('should highlight Cotizaciones when on quotes page', async ({ page }) => {
      await page.goto('/quotes');
      await page.waitForLoadState('networkidle');

      await expect(page.locator('aside a:has-text("Cotizaciones")')).toBeVisible();
    });
